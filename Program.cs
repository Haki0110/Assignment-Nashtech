...
do {
    ...
    //     while(!validateName(Console.ReadLine())){
    ...
    //     while(!validateGender(Console.ReadLine())){
    ...
    //     while(!isContainAllDigit(Console.ReadLine())){
    //         System.Console.WriteLine("Invalid Phone Number, please retype");
    //     }
    //     person.PhoneNumber = Console.ReadLine();

    //     System.Console.WriteLine("Birthplace: ");
    ...
    //     System.Console.WriteLine("Is Graduated");
...
static string ListMalePerson(List<Person> people){
    ...
    foreach(Person person in people){
        if(string.Equals(person.Gender, "male", StringComparison.CurrentCultureIgnoreCase)){
...
static string GetOldestPerson(List<Person> people){
    ...
    stringBuilder.Append($"{person1.FirstName, -15} {person1.LastName, -15} {person1.Gender, -10} {person1.DateOfBirth.ToString("dd/MM/yyyy"), -15} {person1.PhoneNumber, -15} {person1.BirthPlace, -15} {person1.Age, -10} {person1.IsGraduated, -1}\n");
    return stringBuilder.ToString();
}
...
static string GetFirstPersonBornInHanoi(List<Person> people){
    ...
    while (index < people.Count) {
        ...
        if (string.Equals(person.BirthPlace, "hanoi", StringComparison.CurrentCultureIgnoreCase)) {
            stringBuilder.Append($"{person.FirstName, -15} {person.LastName, -15} {person.Gender, -10} {person.DateOfBirth.ToString("dd/MM/yyyy"), -15} {person.PhoneNumber, -15} {person.BirthPlace, -15} {person.Age, -10} {person.IsGraduated, -1}\n");
            break;
        }
        index++;
